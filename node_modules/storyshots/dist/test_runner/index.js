...
var Runner = function () {
  function Runner(options) {
    ...
    this.runner = new _snapshot_runner2.default({ configDir: configDir, update: update, updateInteractive: updateInteractive, storyshotDir: storyshotDir, extension: extension });
  }
  ...
  (0, _createClass3.default)(Runner, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(storybook) {
        var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, group, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, story, result;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 48:
                ...
                // Error on kind
                this.updateState({ state: 'errored-kind', message: _context.t2, name: group.kind });
